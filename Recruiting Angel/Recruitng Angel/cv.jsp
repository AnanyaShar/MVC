...
<html lang="en-US">
  <head>
    ...
    <link href="css3/aos.css" rel="stylesheet">
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link smooth-scroll" href="dashboard.jsp">Dashboard</a></li>
    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="<%=request.getContextPath()%>/upload/<%=user.getImage()%>" alt="Image"/></a></div>
          <div class="h2 title"><%=user.getFirst_name() %>&nbsp<%=user.getLast_name() %></div>
          <p class="category text-white">Curious, Passionate, Hardworking</p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Hello! I am <%=student.getName() %>. Curious, Passionate, Fast Learner.</p>
            <p><%=student.getAbout() %> <a href="https://templateflip.com/templates/creative-cv/" target="_blank">Learn More</a></p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-8"><%=student.getAge() %></div>
            </div>
            <div class="row mt-3">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8"><%=user.getContact_no() %></div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8"><%=student.getAddress() %></div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
              <div class="col-sm-8"><%=student.getLanguage() %></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5"><%=student.getCompany_name() %></div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5"><%=student.getDesignation() %></div>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5"><%=student.getCompany_name2() %></div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5"><%=student.getDescription2() %></div>
            <p><%=student.getDescription2() %></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5"><%=student.getCompany_name3() %></div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5"><%=student.getDesignation3() %></div>
            <p><%=student.getDescription3() %></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container cc-education">
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p><%=student.getSenior_secondary() %></p>
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <p><%=student.getSenior_secondary_about() %></p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="carousel-item active">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/reference-image-1.jpg" alt="Image"/>
                <div class="h5 pt-2"><%=student.getReference_name() %></div>
                <p class="category"><%=student.getReference_designation() %></p>
              </div>
              <div class="col-lg-10 col-md-9">
                <p> <%=student.getReference_description() %></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/reference-image-2.jpg" alt="Image"/>
                <div class="h5 pt-2"><%=student.getReference_name2() %></div>
                <p class="category"><%=student.getReference_designation2() %></p>
              </div>
              <div class="col-lg-10 col-md-9">
                <p> <%=student.getReference_description2() %></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png');">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2"><%=student.getAddress() %></p>
                    <p class="mb-0"><strong>Phone</strong></p>
                    <p class="pb-2"><%=student.getPhone() %></p>
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center"><%=student.getName() %></div>
    ...
    <script src="js3/core/jquery.3.2.1.min.js"></script>
    <script src="js3/core/popper.min.js"></script>
    <script src="js3/core/bootstrap.min.js"></script>
    <script src="js3/now-ui-kit.js?v=1.1.0"></script>
    <script src="js3/aos.js"></script>
